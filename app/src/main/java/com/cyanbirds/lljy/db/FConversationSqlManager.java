...
import com.cyanbirds.lljy.eventtype.DataEvent;
import com.cyanbirds.lljy.greendao.FConversationDao;
...
public class FConversationSqlManager extends DBManager {
	...
	public long insertConversation(long rId, String userData, ECMessage ecMessage) {
		...
		if (!isSend && !"com.cyanbirds.lljy.activity.ChatActivity".equals(AppManager.getTopActivity(mContext))) {
