...
public class PreferencesUtils {
	...
	/** 保存登陆账号 */
	public static final String SETTINGS_RL_ACCOUNT = "com.cyanbird.lljy_account";
	/** 保存登陆密码 */
	public static final String SETTINGS_RL_PASSWORD = "com.cyanbird.lljy_p";
	/** 保存是否第一次启动 */
	public static final String SETTINGS_RL_FIRST_LAUNCHER = "com.cyanbird.lljy_first_launcher";
	/** 用户年龄 */
	public static final String SETTINGS_RL_USER_AGE = "com.cyanbird.lljy_age";
	/** 头像url */
	public static final String SETTINGS_RL_USER_FACE_URL = "com.cyanbird.lljy_face_url";
	/** 手机号 */
	public static final String SETTINGS_RL_USER_MOBILE = "com.cyanbird.lljy_mobile";
	/** 个性签名 */
	public static final String SETTINGS_RL_USER_SIGNATURE = "com.cyanbird.lljy_signature";
	/** 保存用户性别 */
	public static final String SETTINGS_RL_USER_SEX = "com.cyanbird.lljy_sex";
	/** 用户名 */
	public static final String SETTINGS_RL_USER_USER_NAME = "com.cyanbird.lljy_user_name";
	/** 某用户是否第一次登录 */
	public static final String SETTINGS_RL_FIRST_LOGIN = "com.cyanbird.lljy_first_login";
	/** 是否登录 */
	public static final String SETTINGS_RL_IS_LOGIN = "com.cyanbird.lljy_is_login";
	/** 本地头像地址 */
	public static final String SETTINGS_RL_FACE_LOCAL = "com.cyanbird.lljy_face_local";
	/**sessionId */
	public static final String SETTINGS_RL_SESSIONID = "com.cyanbird.lljy_sessionid";
	/**qq号 */
	public static final String SETTINGS_RL_QQ = "com.cyanbird.lljy_qq";
	/**微信号 */
	public static final String SETTINGS_RL_WEIXIN = "com.cyanbird.lljy_weixin";
	/**身高 */
	public static final String SETTINGS_RL_TALL = "com.cyanbird.lljy_tall";
	/**体重 */
	public static final String SETTINGS_RL_WEIGHT = "com.cyanbird.lljy_weight";
	/**距离 */
	public static final String SETTINGS_RL_DISTANCE = "com.cyanbird.lljy_distance";
	/**情感状态 */
	public static final String SETTINGS_RL_EMOTION_STATUS = "com.cyanbird.lljy_emotion_status";
	/**星座 */
	public static final String SETTINGS_RL_CONSTELLATION = "com.cyanbird.lljy_constellation";
	/**城市 */
	public static final String SETTINGS_RL_CITY = "com.cyanbird.lljy_city";
	/**职业 */
	public static final String SETTINGS_RL_OCCUPATION = "com.cyanbird.lljy_occupation";
	/**教育 */
	public static final String SETTINGS_RL_EDUCATION = "com.cyanbird.lljy_education";
	/**交友目的 */
	public static final String SETTINGS_RL_PURPOSE = "com.cyanbird.lljy_purpose";
	/**爱爱地点 */
	public static final String SETTINGS_RL_LOVE_WHERE = "com.cyanbird.lljy_love_where";
	/**首次见面希望 */
	public static final String SETTINGS_RL_DO_WHAT_FIRST = "com.cyanbird.lljy_do_what_first";
	/**恋爱观念 */
	public static final String SETTINGS_RL_CONCEPTION = "com.cyanbird.lljy_conception";
	/**是否显示 */
	public static final String SETTINGS_RL_IS_SHOW = "com.cyanbird.lljy_is_show";
	/**是否vip */
	public static final String SETTINGS_RL_IS_VIP = "com.cyanbird.lljy_is_vip";
	/**isCheckPhone */
	public static final String SETTINGS_RL_IS_CHECK_PHONE = "com.cyanbird.lljy_is_check_phone";
	/**publicSocialNumber */
	public static final String SETTINGS_RL_PUBLIC_SOCIALNUMBER = "com.cyanbird.lljy_public_socialnumber";
	/** 新消息提醒 */
	public static final String SETTINGS_RL_NEW_MESSAGE_NOTICE = "com.cyanbird.lljy_new_message_notice";
	/** 通知显示消息详情 */
	public static final String SETTINGS_RL_NOTICE_MESSAGE_INFO = "com.cyanbird.lljy_notice_message_info";
	/** 通知声音*/
	public static final String SETTINGS_RL_NOTICE_VOICE = "com.cyanbird.lljy_notice_voice";
	/** 通知震动*/
	public static final String SETTINGS_RL_NOTICE_SHOCK = "com.cyanbird.lljy_notice_shock";
	/** 听筒播放*/
	...
	/** 最近喜欢我的userid*/
	public static final String SETTINGS_LOVE_ME_USER_ID = "com.cyanbird.lljy_love_me_user_id";
	/** 最近关注我的userid*/
	public static final String SETTINGS_ATTENTION_ME_USER_ID = "com.cyanbird.lljy_attention_me_user_id";
	/** 最近送我礼物的userid*/
	public static final String SETTINGS_GIFT_ME_USER_ID = "com.cyanbird.lljy_gift_me_user_id";
	/** 登录时间*/
	...
	/** 省份*/
	public static final String SETTINGS_CURRENT_PROVINCE = "com.cyanbirds.lljy_current_province";
	/** (我约会的)改变约会状态的userid*/
	public static final String SETTINGS_I_APPOINT_USER_ID = "com.cyanbirds.lljy_i_appoint_user_id";
	/** (约我的)改变约会状态的userid*/
	public static final String SETTINGS_APPOINT_ME_USER_ID = "com.cyanbirds.lljy_appoint_me_user_id";
	/** 经度*/
	public static final String SETTINGS_LATITUDE = "com.cyanbirds.lljy_latitude";
	/** 纬度*/
	public static final String SETTINGS_LONGITUDE = "com.cyanbirds.lljy_longitude";
