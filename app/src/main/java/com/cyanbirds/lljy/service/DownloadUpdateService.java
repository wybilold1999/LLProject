package com.cyanbirds.lljy.service;
...
import com.cyanbirds.lljy.net.request.DownloadApkFileRequest;
...
//		notification.defaults = Notification.DEFAULT_VIBRATE | Notification.DEFAULT_SOUND;
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		File apkFile = new File(FileAccessorUtils.APK_PATH, "lljy.apk");
		if (apkFile.exists()) {
			apkFile.delete();
		}
		new DownloadApkFileTask().request(apkUrl, FileAccessorUtils.APK_PATH, "lljy.apk");
...
public class DownloadUpdateService extends Service {
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		receiver = new BroadcastReceiver() {
			...
			public void onReceive(Context context, Intent intent) {
				...
				intent.setDataAndType(Uri.fromFile(new File(FileAccessorUtils.APK_PATH, "lljy.apk")),
						"application/vnd.android.package-archive");
	...
	private void DownloadApkFile(String apkUrl) {
		...
		request.setDestinationInExternalPublicDir(FileAccessorUtils.APK_PATH, "lljy.apk");
		dm.enqueue(request);
	}
}*/
